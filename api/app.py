...
def recuperar_contexto_neo4j(pergunta, top_k=3):
    ...
    with driver.session() as session:
        ...
        for record in result:
            if record["score"] < 0.7: # Se o score for menor que 0.7, ignora o artigo
                continue
...
def ask_rag():
    ...
    try:
        ...
        outputs = qwen_pipeline(
            ...
            do_sample=False, # Desativa "criatividade" (greedy decoding), obriga o modelo a ser literal
            repetition_penalty=1.1 # Evita que modelos pequenos fiquem repetindo frases
        )
